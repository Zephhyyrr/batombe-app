...
import com.firman.rima.batombe.data.repository.analyze.AnalyzeRepository
import com.firman.rima.batombe.data.repository.analyze.AnalyzeRepositoryImpl
import com.firman.rima.batombe.data.repository.article.ArticleRepository
import com.firman.rima.batombe.data.repository.article.ArticleRepositoryImpl
import com.firman.rima.batombe.data.repository.example_video.ExampleVideoRepository
import com.firman.rima.batombe.data.repository.example_video.ExampleVideoRepositoryImpl
import com.firman.rima.batombe.data.repository.feed.FeedRepository
import com.firman.rima.batombe.data.repository.feed.FeedRepositoryImpl
import com.firman.rima.batombe.data.repository.generatePantun.GeneratePantunRepository
...
import com.firman.rima.batombe.data.repository.speech.SpeechRepositoryImpl
import com.firman.rima.batombe.data.repository.user.UserRepository
import com.firman.rima.batombe.data.repository.user.UserRepositoryImpl
import dagger.Binds
